<template>
    <div class="add-new-section">
        ...
        <ul class="inline-list" v-if="show">
            ...
            <li class="new-section-structure" @click="addSection(4)">
            ...
            <li class="new-section-structure" @click="addSection(5)">
            ...
            <li class="new-section-structure" @click="addSection(6)">
